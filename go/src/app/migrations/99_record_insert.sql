...
INSERT INTO `questions` (`id`, `question`, `question_display`, `answer_type`, `video_file_name`, `voice_file_name`, `voice_emotion`, `voice_speed`) VALUES ('11', 'はやくちことばします！速さはどれくらいが良いですか？', '早口言葉します！速さはどれくらいが良いですか？', '2', 'questions-11.mp4', 'questions-11.wav', 'happiness', '100');
...
INSERT INTO `questions` (`id`, `question`, `question_display`, `answer_type`, `video_file_name`, `voice_file_name`, `voice_emotion`, `voice_speed`) VALUES ('14', 'びっしゅさんのライブ楽しみですね！', 'BiSHさんのライブ楽しみですね！', '1', 'questions-14.mp4', 'questions-14.wav', 'happiness', '100');
...
INSERT INTO `free_answers` (`id`, `question_id`, `emotion`, `video_file_name`, `voice_file_name`, `answer_display`, `answer`, `voice_emotion`, `voice_speed`) VALUES ('3', '1', '3', 'free_answers-1-3.mp4', 'free_answers-1-3.wav', 'えーー大丈夫ですか？今日は早くおうちに帰りましょう！', 'えーーー、だいじょうぶですか？きょうははやくおうちにかえりましょう！', 'sadness', '100');
...
INSERT INTO `free_answers` (`id`, `question_id`, `emotion`, `video_file_name`, `voice_file_name`, `answer_display`, `answer`, `voice_emotion`, `voice_speed`) VALUES ('6', '5', '3', 'free_answers-5-6.mp4', 'free_answers-5-6.wav', '良い日になるように、私がお祈りしておきます！', 'よいひになるように、私がおいのりしておきます！', 'happiness', '100');
...
INSERT INTO `free_answers` (`id`, `question_id`, `emotion`, `video_file_name`, `voice_file_name`, `answer_display`, `answer`, `voice_emotion`, `voice_speed`) VALUES ('16', '14', '1', 'free_answers-14-16.mp4', 'free_answers-14-16.wav', 'その手と手繋いで〜笑いあった声〜忘れはしないよ〜  ♫ by Bish', 'その手と手繋いで〜笑いあった声〜忘れはしないよ〜  ♫ by ビッシュ', 'happiness', '100');
INSERT INTO `free_answers` (`id`, `question_id`, `emotion`, `video_file_name`, `voice_file_name`, `answer_display`, `answer`, `voice_emotion`, `voice_speed`) VALUES ('17', '14', '2', 'free_answers-14-17.mp4', 'free_answers-14-17.wav', 'その手と手繋いで〜笑いあった声〜忘れはしないよ〜 ♫ by Bish', 'その手と手繋いで〜笑いあった声〜忘れはしないよ〜  ♫ by ビッシュ', 'happiness', '100');
INSERT INTO `free_answers` (`id`, `question_id`, `emotion`, `video_file_name`, `voice_file_name`, `answer_display`, `answer`, `voice_emotion`, `voice_speed`) VALUES ('18', '14', '3', 'free_answers-14-18.mp4', 'free_answers-14-18.wav', 'その手と手繋いで〜笑いあった声〜忘れはしないよ〜 ♫ by Bish', 'その手と手繋いで〜笑いあった声〜忘れはしないよ〜  ♫ by ビッシュ', 'happiness', '100');
...
INSERT INTO `choice_answers` (`id`, `question_id`, `answer`, `answer_display`, `video_file_name`, `voice_file_name`, `choice_display` ,`choice`,`voice_emotion`, `voice_speed`) VALUES ('13', '9', 'せいかいです！よくわかりましたね', '正解です！よくわかりましたね', 'choice_answers-9-13.mp4', 'choice_answers-9-13.wav', '3633', '3633', 'happiness', '100');
...
INSERT INTO `choice_answers` (`id`, `question_id`, `answer`, `answer_display`, `video_file_name`, `voice_file_name`, `choice_display` ,`choice`,`voice_emotion`, `voice_speed`) VALUES ('17', '10', 'わたしはまだたべてないんですよ！ずるいです', '私はまだ食べてないんですよ〜ずるいです', 'choice_answers-10-17.mp4', 'choice_answers-10-17.wav', 'はい', 'はい', 'sadness', '100');
...
INSERT INTO `choice_answers` (`id`, `question_id`, `answer`, `answer_display`, `video_file_name`, `voice_file_name`, `choice_display` ,`choice`,`voice_emotion`, `voice_speed`) VALUES ('19', '11', 'めちゃあぶりかるび、ちゅうあぶりかるび、ちょいあぶりかるび、めちゃあぶりかるび、ちゅうあぶりかるび、ちょいあぶりかるび、めちゃあぶりかるび、ちゅうあぶりかるび、ちょいあぶりかるび', 'めちゃ炙りカルビ、中炙りカルビ、ちょい炙りカルビ（1000倍速）', 'choice_answers-11-19.mp4', 'choice_answers-11-19.wav', 'めちゃくちゃ早', 'めちゃくちゃ早く,めちゃくちゃはやく', 'happiness', '400');
INSERT INTO `choice_answers` (`id`, `question_id`, `answer`, `answer_display`, `video_file_name`, `voice_file_name`, `choice_display` ,`choice`,`voice_emotion`, `voice_speed`) VALUES ('20', '11', 'めちゃあぶりかるび、ちゅうあぶりかるび、ちょいあぶりかるび、めちゃあぶりかるび、ちゅうあぶりかるび、ちょいあぶりかるび、めちゃあぶりかるび、ちゅうあぶりかるび、ちょいあぶりかるび', 'めちゃ炙りカルビ、中炙りカルビ、ちょい炙りカルビ（100倍速）', 'choice_answers-11-20.mp4', 'choice_answers-11-20.wav', '早め', '早く,はやく', 'happiness', '300');
INSERT INTO `choice_answers` (`id`, `question_id`, `answer`, `answer_display`, `video_file_name`, `voice_file_name`, `choice_display` ,`choice`,`voice_emotion`, `voice_speed`) VALUES ('21', '11', 'めちゃあぶりかるび、ちゅうあぶりかるび、ちょいあぶりかるび、めちゃあぶりかるび、ちゅうあぶりかるび、ちょいあぶりかるび、めちゃあぶりかるび、ちゅうあぶりかるび、ちょいあぶりかるび', 'めちゃ炙りカルビ、中炙りカルビ、ちょい炙りカルビ（10倍速）', 'choice_answers-11-21.mp4', 'choice_answers-11-21.wav', '普通', '普通,ふつう', 'happiness', '100');
...
INSERT INTO `requests` (`id`, `video_file_name`, `voice_file_name`, `request_display` ,`request`) VALUES ('3', 'requests-3.mp4', 'requests-3.wav', '歌って', '歌って,うたって');
